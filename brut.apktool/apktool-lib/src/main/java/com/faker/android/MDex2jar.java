...
public class MDex2jar  {
    ...
    public static MDex2jar from(byte[] in) throws IOException {
        return from((BaseDexFileReader)(new DexFileReader(ZipUtil.readDex(in))));
    }

    public static MDex2jar from(ByteBuffer in) throws IOException {
        return from((BaseDexFileReader)(new DexFileReader(in)));
    }

    public static MDex2jar from(BaseDexFileReader reader) {
        return new MDex2jar(reader);
    }

    public static MDex2jar from(File in) throws IOException {
        return from(Files.readAllBytes(in.toPath()));
    }

    public static MDex2jar from(InputStream in) throws IOException {
        return from((BaseDexFileReader)(new DexFileReader(in)));
    }

    public static MDex2jar from(String in) throws IOException {
        return from(new File(in));
    }

    private MDex2jar(BaseDexFileReader reader) {
        this.reader = reader;
        this.readerConfig |= 1;
    }
    ...
    private void doTranslate(final Path dist) throws IOException {
                ...
                return new ClassVisitor(327680, rca) {
                    public void visitEnd() {
                        ...
                        try {
                            ...
                            MDex2jar.this.exceptionHandler.handleFileException(var6);
                            return;
                        }
        ...
        (new ExDex2Asm(this.exceptionHandler) {
            public void convertCode(DexMethodNode methodNode, MethodVisitor mv) {
                if ((MDex2jar.this.readerConfig & 4) == 0 || !methodNode.method.getName().equals("<clinit>")) {
            ...
            public void ir2j(IrMethod irMethod, MethodVisitor mv) {
                (new IR2JConverter(0 != (8 & MDex2jar.this.v3Config))).convert(irMethod, mv);
            }
    ...
    public MDex2jar reUseReg(boolean b) {
        if (b) {
            this.v3Config |= 1;
        } else {
            this.v3Config &= -2;
    ...
    public MDex2jar topoLogicalSort(boolean b) {
        if (b) {
            this.v3Config |= 2;
        } else {
            this.v3Config &= -3;
    ...
    public MDex2jar noCode(boolean b) {
        if (b) {
    ...
    public MDex2jar optimizeSynchronized(boolean b) {
        if (b) {
            this.v3Config |= 8;
        } else {
            this.v3Config &= -9;
    ...
    public MDex2jar printIR(boolean b) {
        if (b) {
            this.v3Config |= 4;
        } else {
            this.v3Config &= -5;
    ...
    public MDex2jar reUseReg() {
        this.v3Config |= 1;
        return this;
    }

    public MDex2jar optimizeSynchronized() {
        this.v3Config |= 8;
        return this;
    }

    public MDex2jar printIR() {
        this.v3Config |= 4;
        return this;
    }

    public MDex2jar topoLogicalSort() {
        this.v3Config |= 2;
        return this;
    }
    ...
    public MDex2jar skipDebug(boolean b) {
        if (b) {
            this.readerConfig |= 1;
        } else {
            this.readerConfig &= -2;
...
//        Files.deleteIfExists(output);
    ...
    public MDex2jar withExceptionHandler(DexExceptionHandler exceptionHandler) {
        this.exceptionHandler = exceptionHandler;
        return this;
    }

    public MDex2jar skipExceptions(boolean b) {
        if (b) {
