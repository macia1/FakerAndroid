...
public class Main {
    ...
    private static void _Options() {
        ...
        Option fkOutputDecOption = Option.builder("o")
                .longOpt("output")
                .desc("The name of project folder that  gets written. Default is apk file name ")
                .hasArg(true)
                .argName("dir")
                .build();
        ...
        fkOptions.addOption(fkOutputDecOption);
        // check for advance mode
        if (isAdvanceMode()) {
    ...
    private static void fakerAndroidUsage(){
        _Options();
        HelpFormatter formatter = new HelpFormatter();
        formatter.setWidth(120);
//        // print out license info prior to formatter.
        System.out.println("FakerAndroid is a tool for translating a Android apk file to common android project \n" +
                         "with apktool v 2.4.2" +
        ...
        formatter.printHelp("FakerAndroid " + verbosityHelp() + "b[uild] [options] <app_path>", BuildOptions);
        formatter.printHelp("FakerAndroid " + verbosityHelp() + "if|install-framework [options] <framework.apk>", frameOptions);
    ...
    private final static Options fkOptions;

    static {
        //normal and advance usage output
        fkOptions = new Options();
